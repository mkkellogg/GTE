...
obj/blendop.o: $(ANIMATIONSRC)/blendop.cpp $(ANIMATIONSRC)/blendop.h
	$(CC) $(CFLAGS) -o obj/blendop.o -c $(ANIMATIONSRC)/blendop.cpp
	
obj/crossfadeblendop.o: $(ANIMATIONSRC)/crossfadeblendop.cpp $(ANIMATIONSRC)/crossfadeblendop.h
	$(CC) $(CFLAGS) -o obj/crossfadeblendop.o -c $(ANIMATIONSRC)/crossfadeblendop.cpp
