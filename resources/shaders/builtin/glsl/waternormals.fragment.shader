...
void main()
{
  ...
  /*  float ch = texture2D(WATER_HEIGHT_MAP, vUVTexture0.st).g;
    ...
    y[0] = texture(WATER_HEIGHT_MAP, vUVTexture0.st + vec2(ODWNMR, 0.0)).g;
    y[1] = texture(WATER_HEIGHT_MAP, vUVTexture0.st + vec2(0.0, ODWNMR)).g;
    y[2] = texture(WATER_HEIGHT_MAP, vUVTexture0.st - vec2(ODWNMR, 0.0)).g;
    y[3] = texture(WATER_HEIGHT_MAP, vUVTexture0.st - vec2(0.0, ODWNMR)).g;
