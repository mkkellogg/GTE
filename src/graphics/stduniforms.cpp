...
const char* const StandardUniforms::uniformNames[] = {"MODEL_MATRIX","MODELVIEW_MATRIX","MODELVIEWPROJECTION_MATRIX","PROJECTION_MATRIX","LIGHT_POSITION", "LIGHT_DIRECTION", "LIGHT_COLOR", "LIGHT_INTENSITY", "LIGHT_ATTENUATION", "LIGHT_ISDIRECTIONAL", "EMISSIVECOLOR", "TEXTURE0", "TEXTURE1", "NORMALMAP"};
