...
bool Shader::CheckCompilation(int shaderID, ShaderType shaderType)
{
...
char * Shader::GetProgramLog(GLuint obj)
{
    int infologLength = 0;
...
char * Shader::GetShaderLog(GLuint obj)
{
    int infologLength = 0;
